...
const Features = () => {
  return (
    <div className="relative">
      <div class="absolute top-0 left-0 w-[100px] h-[100px] bg-[#8b1919] blur-3xl "></div>
      <div class="absolute bottom-0 right-0 w-[100px] h-[100px] bg-[#8b1919] blur-3xl "></div>
      <div
        className="bg-black min-h-screen flex flex-col items-center justify-center text-white 
    px-8 "
      >
